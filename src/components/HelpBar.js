  ...
  return(
    <div>
      ...
      <div id='helpText'>
        ...
        <img className="helpIcons" src={require("../images/upArrow.svg")}/><br/><br/>
        ...
        <img className="helpIcons" src={require("../images/doubleClick.svg")}/>&nbsp;&nbsp;d o u b l e&nbsp; c l i c k&nbsp; t h e&nbsp; s o n g&nbsp; t o&nbsp; s h o w&nbsp; i t s&nbsp; t i t l e<br/><br/>
      </div>
